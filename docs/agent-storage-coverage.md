...
| --- | --- | --- | --- | --- |
| `aider-desk` | `not-supported` | `deferred local history` | npx `~/.aider-desk`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
...
| `autohand-code` | `not-supported` | `deferred local history` | npx `AUTOHAND_HOME or ~/.autohand`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
| `augment` | `supported` | `CLI session JSON` | ctx `auggie_session_json`; npx `~/.augment` | - |
| `bob` | `not-supported` | `deferred local history` | npx `~/.bob`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
...
| `codestudio` | `not-supported` | `deferred local history` | npx `~/.codestudio`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
| `codex` | `supported` | `JSONL CLI event logs` | ctx `codex_session_jsonl_tree`; npx `CODEX_HOME` | - |
| `command-code` | `not-supported` | `deferred local history` | npx `~/.commandcode`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
| `continue` | `supported` | `CLI session JSON` | ctx `continue_cli_sessions_json`; npx `.continue or ~/.continue` | - |
| `cortex` | `not-supported` | `deferred local history` | npx `~/.snowflake/cortex`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
...
| `dexto` | `not-supported` | `deferred local history` | npx `~/.dexto`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
| `droid` | `supported` | `JSONL CLI event logs` | ctx `factory_ai_droid_sessions_jsonl`; npx `~/.factory` | - |
| `eve` | `not-supported` | `deferred local history` | npx `agent project marker`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
...
| `iflow-cli` | `not-supported` | `deferred local history` | npx `IFLOW_HOME or ~/.iflow`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
| `jazz` | `not-supported` | `deferred local history` | npx `JAZZ_HOME or ~/.jazz/history`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
...
| `kode` | `not-supported` | `deferred local history` | npx `~/.kode`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
| `lingma` | `supported` | `VS Code/Electron storage` | ctx `lingma_sqlite`; npx `~/.lingma` | - |
| `loaf` | `not-supported` | `deferred local history` | npx `~/.loaf`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
...
| `moxby` | `not-supported` | `deferred local history` | npx `~/.moxby`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
| `mux` | `supported` | `JSONL CLI event logs` | ctx `mux_session_jsonl_tree`; npx `MUX_ROOT or ~/.mux` | - |
| `neovate` | `not-supported` | `deferred local history` | npx `~/.neovate`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
...
| `reasonix` | `not-supported` | `deferred local history` | npx `~/.reasonix/sessions`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
...
| `terramind` | `not-supported` | `deferred local history` | npx `terramind package config`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
| `tinycloud` | `not-supported` | `deferred local history` | npx `~/.tinycloud`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
...
| `zenflow` | `not-supported` | `deferred local history` | npx `~/.zencoder`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
| `pochi` | `not-supported` | `deferred local history` | npx `~/.pochi`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
...
| `adal` | `not-supported` | `deferred local history` | npx `~/.adal`; no ctx provider on this branch | Not claimed until demand and storage provenance justify public native support. |
