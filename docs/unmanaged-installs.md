...
```text
https://github.com/ctxrs/ctx/releases/download/v0.22.0/ctx-linux-x64
https://github.com/ctxrs/ctx/releases/download/v0.22.0/SHA256SUMS
```
...
```bash
mise use -g 'github:ctxrs/ctx[bin=ctx]@0.22.0'
```
