...
RUST_FORMAT_TARGETS = [
    ...
    "//crates/ctx-attribution-model:unit_tests",
    "//crates/ctx-attribution:unit_tests",
    "//crates/ctx-attribution-derivation:unit_tests",
    "//crates/ctx-attribution-index:unit_tests",
    "//crates/ctx-repository-evidence:unit_tests",
    ...
    "//crates/ctx-cli:unified_context_tests",
    ...
    "//crates/ctx-graph:unit_tests",
    "//crates/ctx-graph:cli_tests",
    "//crates/ctx-output:unit_tests",
    "//crates/ctx-output-codec:unit_tests",
    "//crates/ctx-output-codec:tokenizer_tests",
