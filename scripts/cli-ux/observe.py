...
import _observe_processes  # noqa: E402
...
TERM_GRACE_SECONDS = _observe_processes.TERM_GRACE_SECONDS
KILL_GRACE_SECONDS = _observe_processes.KILL_GRACE_SECONDS
READ_SIZE = 65_536

_signal_process_group = _observe_processes._signal_process_group
_process_identity = _observe_processes._process_identity
_process_diagnostic = _observe_processes._process_diagnostic
_direct_child_pids = _observe_processes._direct_child_pids
_pids_in_capture_scope = _observe_processes._pids_in_capture_scope
_reap_pid = _observe_processes._reap_pid
_reap_terminated_children = _observe_processes._reap_terminated_children
_settle_capture_scope = _observe_processes._settle_capture_scope
_terminate_pids = _observe_processes._terminate_pids
...
def observe(
    ...
    *,
    ...
    processes_path = Path(_observe_processes.__file__).resolve()
    processes_sha256 = _file_sha256(processes_path)
    ...
    try:
        ...
        if _file_sha256(processes_path) != processes_sha256:
            raise ObservationError("observer changed during observation")
