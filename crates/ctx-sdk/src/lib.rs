...
const MAX_RETAINED_SUBPROCESS_STDERR_BYTES: usize = 64 * 1024;
...
fn collect_ctx_json(mut child: Child, timeout: Duration) -> Result<Value, AgentHistoryError> {
...
fn read_bounded_pipe(mut pipe: impl Read, maximum: usize) -> io::Result<Vec<u8>> {
