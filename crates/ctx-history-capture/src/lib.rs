...
pub use provider::source_backed::{
    ...
    source_backed_route_inventory, source_backed_source_failure_identity,
    BorrowedIndexManifestView, CaptureDocumentSpool, CaptureProviderRuntime,
    CommittedIndexManifestView, CrushProjectDatabaseV0, CrushProjectInventoryObservationV0,
    CrushProjectInventorySourceV0, IndexCaptureCommitReceipt, IndexCaptureVerifiedPin,
    IndexManifestView, IndexVerifiedCapture, RouteObservation, SourceBackedAutomaticRegistryBuild,
    ...
    SourceBackedDetailedRefreshProgress, SourceBackedFailedRoute, SourceBackedFailedRouteOutcome,
    SourceBackedGenerationSink, SourceBackedLogicalSourceFailure,
    SourceBackedLogicalSourceFailures, SourceBackedProviderRegistry,
    SourceBackedProviderRouteMetadata, SourceBackedReconciliationDemand,
    SourceBackedRecordCompletion, SourceBackedRecordRejection, SourceBackedRecordRejectionClass,
    SourceBackedRecordRejections, SourceBackedRefreshExecutor, SourceBackedRefreshProgress,
    SourceBackedRefreshReceipt, SourceBackedRefreshScope, SourceBackedRevalidationTarget,
    SourceBackedRoute, SourceBackedRouteConstructor, SourceBackedRouteControlExpectation,
    ...
    SqliteInventoryCoverage, LANDED_SOURCE_BACKED_ROUTES, MAX_RECORDED_SOURCE_BACKED_FAILURES,
