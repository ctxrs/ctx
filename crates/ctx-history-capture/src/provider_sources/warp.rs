...
pub fn discover_warp_sources_with_authority(
    ...
    resolve_warp_with_authority(context, warp_spec()?)
}
...
pub fn resolve_warp_discovery_authority(
    ...
    discover_warp_sources_with_authority(context)?
        .into_iter()
...
mod tests {
    ...
    fn linux_discovery_retains_channel_and_terminal_surface_authority() {
        ...
        let discovered = discover_warp_sources_with_authority(&context).unwrap();
    ...
    fn lookup_reemits_authority_and_rejects_nonselected_sources() {
        ...
        let selected = resolve_warp_discovery_authority(&context, &source).unwrap();
        ...
        assert_eq!(
            resolve_warp_discovery_authority(&context, &unselected),
    ...
    fn unavailable_platform_authority_fails_closed() {
        ...
        assert_eq!(
            discover_warp_sources_with_authority(&other_unix),
        ...
        assert_eq!(
            discover_warp_sources_with_authority(&windows),
