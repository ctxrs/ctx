...
#[derive(Debug)]
struct GenerationLineageCacheV0 {
...
impl CodexOutcomeLineageAuthorityV0 {
    ...
    pub(super) fn initialize_generation_spill(
        &mut self,
    ...
    pub(super) fn spill_generation_component(
        &mut self,
        component: u64,
    ) -> CodexSourceBackedResultV0<()> {
    ...
    pub(super) fn generation_component_has_spilled_facts(
        &self,
        component: u64,
    ...
    pub(super) fn lease_generation_component(
        &self,
        component: u64,
    ) -> CodexSourceBackedResultV0<()> {
        let component = usize::try_from(component)
    ...
    pub(super) fn release_generation_component(
        &self,
        component: u64,
    ) -> CodexSourceBackedResultV0<()> {
        let component = usize::try_from(component)
    ...
    #[cfg(test)]
    pub(super) fn set_generation_component_budget_limits(
        &mut self,
        byte_limit: usize,
        fact_limit: usize,
    ) {
    ...
    #[cfg(test)]
    pub(super) fn generation_component_metrics(&self) -> (usize, usize, usize, usize, usize) {
