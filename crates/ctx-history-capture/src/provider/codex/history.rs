...
use crate::{
    ...
    ProviderCaptureAdapter, ProviderImportFailure, ProviderImportSummary, ProviderJsonlReader,
...
impl ProviderCaptureAdapter for CodexHistoryJsonlAdapter {
    ...
    fn normalize_path(
        ...
        normalize_codex_history_jsonl_reader(&mut reader, context)
    }
}

pub(crate) fn normalize_codex_history_jsonl_reader(
    ...
    while reader.read_record_or_skip_oversized(&mut line, &mut line_number, &mut result.summary)? {
