...
use super::{
    detect_schema, hash_candidate, initial_prefix_hasher, lingma_source_snapshot, load_candidates,
    load_raw_row,
...
fn source_observation(
    ...
    hash_revision_field(&mut revision, snapshot.revision_component().as_bytes());
