use crate::provider::importer::{
    import_normalized_provider_captures, provider_cursor_stream, provider_event_seq,
    provider_event_uuid, provider_file_touch_uuid, provider_scoped_source_uuid,
    provider_session_uuid, provider_source_cursor_stream, provider_source_edge_uuid,
    provider_source_event_seq, provider_source_root_identity, provider_source_session_uuid,
    provider_source_uuid, provider_sync_metadata, timestamps,
};
use crate::tests::support::paths::tempdir;
use crate::tests::support::provider_state::{
    assert_provider_source_collision_is_distinct, provider_collision_capture,
    provider_collision_file_touch,
};
use crate::{
    compute_payload_hash, stable_capture_uuid, NormalizedProviderImportOptions,
