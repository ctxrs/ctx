...
use ctx_history_index_query::{
    ...
    LexicalSearchError, LexicalSearchResult, SearchAgentScope, SearchContentScope, SearchFamilyKey,
    SessionGroupingClaims, VerifiedIndex, LEXICAL_QUERY_LIMITS, MAX_LEXICAL_QUERY_RESULTS,
};
