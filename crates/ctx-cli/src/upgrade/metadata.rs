...
use super::{
    types::ReleaseMetadata,
    util::{env_flag, sha256_hex},
};

pub(super) const RELEASE_METADATA_MAX_BYTES: usize = 1024 * 1024;
pub(super) const RELEASE_METADATA_SIGNATURE_MAX_BYTES: usize = 64 * 1024;
pub(super) const RELEASE_ARTIFACT_MAX_BYTES: usize = 128 * 1024 * 1024;
...
pub(super) fn parse_metadata_map(text: &str) -> Result<BTreeMap<String, String>> {
