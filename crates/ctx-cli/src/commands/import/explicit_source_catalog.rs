...
impl ExplicitSourceCatalogAuthority {
    ...
    pub(crate) fn route_lineages(&self) -> BTreeSet<String> {
        self.entries
            .iter()
    ...
    pub(crate) fn relocation_authority(
        &self,
        old_path: &Path,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct ExplicitSourceRelocationAuthority {
    revision: u64,
...
pub(crate) fn relocate_explicit_source(
    data_root: &Path,
    source: &ProviderSource,
