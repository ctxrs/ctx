...
pub(super) fn hydrate_evidence_previews(
    ...
    hydrate_evidence_previews_with(
        ...
        |generation_id, event_ids, maximum_events, budget| {
            ...
            Ok(index
                .core_events_by_ids_with_strict_budget(event_ids, maximum_events, budget)?
...
fn evidence_hydration_budget(unique_records: usize) -> CoreEventPageBudget {
    ...
    CoreEventPageBudget::new(aggregate_bytes, aggregate_bytes)
}
