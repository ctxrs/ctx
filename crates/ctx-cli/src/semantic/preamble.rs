...
const SEMANTIC_VECTOR_BACKEND_SQLITE_VEC: &str = "sqlite_vec0_binary_rerank";
const SEMANTIC_SQLITE_VEC0_MAX_K: usize = 16_384;
const SEMANTIC_SQLITE_VEC0_OVERFETCH_FACTOR: usize = 8;
const SEMANTIC_SQLITE_VEC0_MIN_CANDIDATES: usize = 128;
const SEMANTIC_BINARY_VECTOR_BYTES: usize = (SEMANTIC_DIMENSIONS + 7) / 8;
...
const SEMANTIC_SIDECAR_SCHEMA_VERSION: i64 = 7;
const SEMANTIC_SIDECAR_TRUST_VERSION: i64 = 2;
const SEMANTIC_SQLITE_VEC0_PROJECTION_VERSION: i64 = 3;
