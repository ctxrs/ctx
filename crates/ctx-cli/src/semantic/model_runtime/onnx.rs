...
#[cfg(ctx_semantic_fastembed)]
pub(super) const CTX_ONNXRUNTIME_DIR_ENV: &str = "CTX_ONNXRUNTIME_DIR";
#[cfg(ctx_semantic_fastembed)]
pub(super) const CTX_ONNXRUNTIME_CACHE_DIR_ENV: &str = "CTX_ONNXRUNTIME_CACHE_DIR";
#[cfg(ctx_semantic_fastembed)]
pub(super) const CTX_RUNTIME_DIR_ENV: &str = "CTX_RUNTIME_DIR";
#[cfg(ctx_semantic_fastembed)]
...
pub(super) struct SemanticOnnxRuntimeEnv {
...
#[cfg(ctx_semantic_fastembed)]
pub(super) fn semantic_onnxruntime_selected_data_root(model_cache_dir: &Path) -> Option<&Path> {
...
#[cfg(ctx_semantic_fastembed)]
pub(super) fn semantic_onnxruntime_default_cache_dir(model_cache_dir: &Path) -> PathBuf {
...
mod ort_runtime_tests {
    ...
    fn onnxruntime_invalid_shared_library_fails_without_deadlock() {
        ...
        const TEST_NAME: &str =
            "semantic::model_runtime::onnx::ort_runtime_tests::onnxruntime_invalid_shared_library_fails_without_deadlock";
        let library = [
