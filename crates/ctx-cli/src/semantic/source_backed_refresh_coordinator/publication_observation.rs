...
pub(super) fn admitted_route_observations(
...
#[cfg(test)]
pub(super) fn install_after_capture_scan_before_metadata_hook_for_test(
...
#[cfg(test)]
pub(super) fn run_after_capture_scan_before_metadata_hook() {
    AFTER_CAPTURE_SCAN_BEFORE_METADATA_HOOK.with(|slot| {
