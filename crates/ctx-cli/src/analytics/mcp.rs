...
impl McpToolV1 {
    pub(crate) fn from_name(name: Option<&str>) -> Self {
        match name {
            ...
            Some("show_resource") => Self::ShowResource,
            Some("locate_resource") => Self::LocateResource,
            Some("blame") => Self::Blame,
            Some("timeline") => Self::Timeline,
            Some("related") => Self::Related,
            Some("facts") => Self::Facts,
    ...
    pub(crate) fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ShowResource => "show_resource",
            Self::LocateResource => "locate_resource",
            Self::Blame => "blame",
