...
pub const RELATIONAL_PROJECTION_SCHEMA_VERSION: u32 = 8;
pub const RELATIONAL_PROJECTION_CONTRACT_VERSION: u32 = 8;
pub const RELATIONAL_MATERIALIZER_REVISION: u32 = 4;
