...
pub use core_record::{
    ...
    repository_result_map_sha256, CoreContent, CoreContentPolicyStatus, CoreDiscoveryExclusion,
    CoreRecord, CoreRecordAnnotation, CoreRecordError, CoreRecordResult, EventCopyProofKind,
    EventOrigin, GitObjectFormat, GitObjectId, McpExchangeContent, McpFailureKind,
    McpInvocationContent, McpJsonCapture, McpPayloadOmissionReason, McpTerminalResponseContent,
    McpTerminalStatus, McpTextCapture, McpToolCallAttribution, RepositoryAbstention,
