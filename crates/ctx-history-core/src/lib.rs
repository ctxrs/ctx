...
pub use core_record::{
    ...
    CORE_CONTENT_POLICY_REVISION, CORE_MCP_TOOL_CALL_ATTRIBUTION_REVISION,
    CORE_MISSING_ACTIVITY_TIME_UNIX_MS, CORE_NORMALIZATION_REVISION,
    ...
    MAX_ENCODED_CORE_RECORD_BYTES, MAX_MCP_TOOL_CALL_ATTRIBUTION_COMPONENT_BYTES,
};
pub use dtos::{
