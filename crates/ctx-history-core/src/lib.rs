...
pub use core_record::{
    ...
    core_record_leaf_sha256, repository_commit_operation_event_id, repository_outcome_receipt_id,
    repository_result_map_sha256, CoreContent, CoreContentPolicyStatus, CoreRecord,
    CoreDiscoveryExclusion, CoreRecordAnnotation, CoreRecordError, CoreRecordResult,
    EventCopyProofKind, EventOrigin,
    GitObjectFormat, GitObjectId, McpExchangeContent, McpFailureKind, McpInvocationContent,
    McpJsonCapture, McpPayloadOmissionReason, McpTerminalResponseContent, McpTerminalStatus,
    McpTextCapture, McpToolCallAttribution, RepositoryAbstention, RepositoryAbstentionReason,
    ...
    RepositoryCommitMappingCompleteness, RepositoryCommitOperationClass,
    ...
    RepositoryVerifiedYieldProof, SessionRelationshipKind, CORE_BOUNDED_SHELL_SUBSET_REVISION,
    CORE_CONTENT_POLICY_REVISION, CORE_MCP_EXCHANGE_REVISION,
    CORE_MCP_TOOL_CALL_ATTRIBUTION_REVISION, CORE_MISSING_ACTIVITY_TIME_UNIX_MS,
    ...
    CORE_REPOSITORY_CONTRACT_REVISION, CORE_REPOSITORY_LOCAL_ROOT_AUTHORIZATION_FINGERPRINT_DOMAIN,
    ...
    MAX_CORE_CONTENT_BYTES, MAX_ENCODED_CORE_RECORD_BYTES, MAX_MCP_EXCHANGE_CALL_ID_BYTES,
    MAX_MCP_TOOL_CALL_ATTRIBUTION_COMPONENT_BYTES, MAX_REPOSITORY_COMMIT_OPERATION_MAPPINGS,
};
pub use dtos::{
