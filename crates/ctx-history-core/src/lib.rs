...
pub use core_record::{
    ...
    core_record_leaf_sha256, CoreContent, CoreContentPolicyStatus, CoreDiscoveryExclusion,
    ...
    RepositoryCandidate, RepositoryCandidateEvidence, RepositoryCandidateKind, RepositoryEvidence,
    ...
    RepositoryVcsObservation, RepositoryVcsObservationKind, SessionRelationshipKind,
