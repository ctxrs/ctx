...
pub use core_record::{
    ...
    CORE_BOUNDED_SHELL_SUBSET_REVISION, CORE_CONTENT_POLICY_REVISION,
    CORE_MISSING_ACTIVITY_TIME_UNIX_MS, CORE_NORMALIZATION_REVISION, CORE_RECORD_VERSION,
    CORE_REPOSITORY_CONTRACT_REVISION, CORE_REPOSITORY_LOCATOR_FINGERPRINT_DOMAIN,
    CORE_REPOSITORY_LOCATOR_FINGERPRINT_REVISION, CORE_REPOSITORY_OBSERVATION_REVISION,
    CORE_REPOSITORY_OUTCOME_CAPTURE_REVISION, MAX_CORE_CONTENT_BYTES,
