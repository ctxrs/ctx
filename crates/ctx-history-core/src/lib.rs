...
pub use core_record::{
    ...
    CoreRecordAnnotation, CoreRecordError, CoreRecordResult, EventCopyProofKind, EventOrigin,
    ...
    RepositoryEvidenceKind, RepositoryFileInvocationEvidence,
    ...
    CORE_BOUNDED_SHELL_SUBSET_REVISION, CORE_CONTENT_POLICY_REVISION, CORE_MCP_EXCHANGE_REVISION,
