...
pub use core_record::{
    ...
    McpToolCallAttribution, RepositoryAbstention, RepositoryAbstentionReason, RepositoryAlias,
    RepositoryAliasKind, RepositoryBinding, RepositoryCandidate, RepositoryCandidateEvidence,
    RepositoryCandidateKind, RepositoryEvidence, RepositoryEvidenceConfidence,
    ...
    MAX_ENCODED_CORE_RECORD_BYTES, MAX_MCP_EXCHANGE_CALL_ID_BYTES,
