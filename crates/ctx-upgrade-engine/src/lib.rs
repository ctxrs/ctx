...
pub use upgrade::{
    ...
    reconcile_current_man_pages, run_hosted_transaction, terminal_installation_upgrade_attempt_id,
    try_acquire_managed_installation_mutation, unmanaged_install_conversion_guidance,
