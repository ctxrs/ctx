...
pub use upgrade::{
    ...
    run_hosted_transaction, terminal_installation_upgrade_attempt_id,
    unmanaged_install_conversion_guidance, upgrade_diagnostics, ArtifactAddressPolicy,
    AutomaticUpgradeObservation, AutomaticUpgradePolicyProvider, AutomaticUpgradePolicySnapshot,
    DaemonRestart, DaemonUpgradeLease, DaemonUpgradePort, HostedTransactionAction,
    HostedTransactionArgs, InstallMarker, ManagedInstallDiagnostic, ManagedInstallMarker,
