...
// Schema 9 has the same native message identity and required columns.
// Later session metadata is already selected through optional-column fallbacks.
const GOOSE_NATIVE_SCHEMA_VERSIONS: [i64; 2] = [9, 15];
