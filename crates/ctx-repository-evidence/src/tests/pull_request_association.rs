use super::super::{LiteralPullRequestAssociationObservation, git::EventProbeBudget};
use super::*;

fn association(repo: &Path, merged_as: String) -> LiteralPullRequestAssociationObservation {
    LiteralPullRequestAssociationObservation {
...
fn exact_two_parent_merge_enriches_the_atomic_first_to_second_parent_range() {
    ...
    let association = evaluated_association(&repo, merged_as.clone());
