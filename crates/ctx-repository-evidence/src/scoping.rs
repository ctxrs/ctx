...
use crate::model::{
    RepositoryAbstentionReason, RepositoryEvaluation, RepositoryEvidence,
...
use super::{
    CertifiedCandidate, ScopedFileInput, ScopedRepositoryFileInvocationEvidence, ScopedVcsInput,
    identity::binding_accepts_forge_repository, push_abstention,
};
...
fn exact_provider_outcome_binding(
    annotation: &RepositoryEvaluation,
