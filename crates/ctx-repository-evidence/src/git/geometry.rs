...
use crate::model::{GitObjectFormat, LOCAL_ROOT_AUTHORIZATION_FINGERPRINT_DOMAIN};
use sha2::{Digest, Sha256};

use super::{
    CandidateKind, MAX_GIT_OUTPUT_BYTES, MAX_PARENT_COMPONENTS, ProbeFailure,
...
///
/// SHA-256 input is `LOCAL_ROOT_AUTHORIZATION_FINGERPRINT_DOMAIN`, big-endian
...
pub(super) fn repository_local_root_authorization_fingerprint(
    ...
    {
        let mut digest = Sha256::new();
        digest.update(LOCAL_ROOT_AUTHORIZATION_FINGERPRINT_DOMAIN);
