use crate::model::GitObjectId;

use super::{
    CertifiedCandidate, EventProbeBudget, GitCertifier, MAX_VERIFIED_COMMIT_OPERATION_OBJECTS,
    ProbeFailure, repository_mutable_evidence_state, repository_object_domain_sha256, utf8_lines,
};
...
impl GitCertifier {
    ...
    pub(crate) fn verify_commit_operation_objects(
        &self,
