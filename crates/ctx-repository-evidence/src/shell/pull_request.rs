...
use crate::model::{RepositoryAlias, RepositoryAliasKind};
use url::Url;

use super::super::association::canonical_url_authority;
use super::{MAX_COMMAND_BYTES, strip_comments_and_bound_heredocs, tokenize};

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct BoundedPullRequestAssociationQuery {
...
pub fn bounded_pull_request_association_query(
    command: &str,
    base: &Path,
