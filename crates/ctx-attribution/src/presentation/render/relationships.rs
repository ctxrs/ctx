use ctx_attribution_model::{AgentAttribution, ProductionRelationship};

use ctx_terminal::ui::{Document, RenderContext, Token};

use super::layout::{
    METADATA_LABEL_WIDTH, confidence_token, push_enum_field, push_field, push_heading,
...
pub(super) fn render_session_lineage(
    ...
    context: &RenderContext,
    indent: usize,
    parent_session: Option<&ctx_attribution_model::ResourceRef>,
    owning_root: Option<&ctx_attribution_model::ResourceRef>,
) {
