...
use super::layout::{
    METADATA_LABEL_WIDTH, enum_heading, enum_text, push_field, push_heading, push_notice,
    push_references, push_role_resource, timestamp_text,
};
...
fn render_operation(
    ...
    if let Some(observed_at_ms) = observed_at_ms {
        push_field(
            ...
            "observed",
            METADATA_LABEL_WIDTH,
            &timestamp_text(context, observed_at_ms),
            Token::Text,
            true,
        );
    }
