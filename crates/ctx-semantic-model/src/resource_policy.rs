...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct SemanticQuietPolicy {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct SemanticModelLoadResourceFacts {
    available_memory_bytes: Option<u64>,
    required_available_memory_bytes: u64,
}

impl SemanticModelLoadResourceFacts {
    pub const fn available_memory_bytes(self) -> Option<u64> {
        self.available_memory_bytes
    }

    pub const fn required_available_memory_bytes(self) -> u64 {
        self.required_available_memory_bytes
    }
}

pub fn semantic_model_load_resource_facts() -> SemanticModelLoadResourceFacts {
    SemanticModelLoadResourceFacts {
        available_memory_bytes: SemanticSystemResources::current().available_memory_bytes,
        required_available_memory_bytes: SEMANTIC_CPU_MODEL_LOAD_MIN_AVAILABLE_BYTES,
    }
}
