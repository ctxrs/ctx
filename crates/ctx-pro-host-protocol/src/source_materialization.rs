...
pub const MAX_SOURCE_MATERIALIZATION_BATCH_ITEMS: usize = 64;
pub const MAX_SOURCE_MATERIALIZATION_BATCH_RECORDS: usize = MAX_SOURCE_RECORDS_PER_PAGE;
pub const MAX_SOURCE_MATERIALIZATION_BATCH_CONTENT_BYTES: usize = MAX_SOURCE_CONTENT_BYTES_PER_PAGE;
pub const MAX_SOURCE_MATERIALIZATION_BATCH_WIRE_BYTES: usize = MAX_SOURCE_PAGE_WIRE_BYTES;
