...
pub use source_materialization::{
    ...
    ReadSourceProgressPageRequest, SourceCommandFact, SourceDeleted, SourceDisposition,
    SourceManifest, SourceManifestAdmissionBegan, SourceManifestAdmissionCursor,
    ...
    SourceMessageFact, SourceOutcome, SourcePageMaterialized, SourcePrepared, SourceProgress,
    SourceProgressPage, SourceProgressReceipt, SourceRecord, SourceRecordMetadata, SourceRemoval,
    SourceRepositoryContext, SourceResultFact, SourceSessionRelationships,
    SourceWorktreeRootLocator, TransientSourceContent, TransientSourceFact,
    MAX_SOURCE_CONTENT_BYTES, MAX_SOURCE_CONTENT_BYTES_PER_PAGE, MAX_SOURCE_CONTROL_WIRE_BYTES,
    MAX_SOURCE_FACTS_PER_RECORD, MAX_SOURCE_IDENTITY_BYTES, MAX_SOURCE_INVENTORY_SOURCES,
    MAX_SOURCE_MANIFEST_PAGE_ITEMS, MAX_SOURCE_MANIFEST_PAGE_WIRE_BYTES,
    MAX_SOURCE_MANIFEST_REMOVALS, MAX_SOURCE_MANIFEST_SOURCES, MAX_SOURCE_MANIFEST_WIRE_BYTES,
    MAX_SOURCE_PAGE_WIRE_BYTES, MAX_SOURCE_PATH_BYTES, MAX_SOURCE_PROGRESS_PAGE_ITEMS,
    MAX_SOURCE_PROGRESS_PAGE_WIRE_BYTES, MAX_SOURCE_PROGRESS_SOURCES, MAX_SOURCE_RECORDS_PER_PAGE,
