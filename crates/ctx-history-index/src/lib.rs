...
pub use ctx_history_index_query::{
    ...
    RankedEventRef, SearchContentScope, SemanticEligibility, SemanticEventCursor,
    SemanticEventPage, SemanticFilterProjection, SessionEventCoordinate, SessionEventCursor,
    SessionRecord, SourceEventCursor, SourceEventPage, StoredCoreEventRecord, StoredCoreRecordJson,
