...
struct LocalAgentHistorySmoke {
    static func main() throws {
        ...
        let search = try client.search(
            try SearchQueryV1(any: [.all("local agent history")], must: [.all("codex")]),
...
private final class FakeSmokeRunner: CommandRunner, @unchecked Sendable {
    ...
    {"schema_version":2,"query":{"version":"ctx-search-v1","any":[{"all":"local agent history"}]},"query_execution":{"query_version":"ctx-search-v1","candidate_strategy":"bounded_fts","resolved":{"query_bytes":8192,"clauses":32,"analyzed_tokens_per_clause":32,"candidates_per_positive_seed":1024,"candidate_rows":16384,"retained_candidate_ids":8192,"residual_rows":8192,"verification_bytes":16777216,"verification_lookup_bytes":16384,"hydrated_rows":256,"hydration_input_bytes":8388608,"hydration_input_bytes_per_event":65536,"snippet_input_bytes":8388608,"returned_text_bytes":524288,"serialized_response_bytes":2097152,"results":200,"elapsed_ms":1000},"consumed":{"query_bytes":19,"clauses":1,"analyzed_tokens":3,"largest_analyzed_tokens_per_clause":3,"largest_positive_seed_candidates":1,"candidate_rows":1,"retained_candidate_ids":1,"residual_rows":1,"verification_bytes":16,"largest_verification_lookup_bytes":16,"hydrated_rows":1,"hydration_input_bytes":32,"largest_hydration_input_bytes":32,"snippet_input_bytes":32,"returned_results":1,"returned_text_bytes":32,"serialized_response_bytes":1000,"elapsed_ms":2},"semantic":{"attempted":false,"required":false,"readiness":"unavailable","effective_backend":"lexical","requested_candidates":0,"eligible_candidates":0,"candidates_supplied":0,"candidates_consumed":0,"candidates_used":0,"coverage":{},"completeness":"not_attempted","positive_text_rule_version":"ctx-search-positive-text-v1"},"rrf_k":60,"per_branch_candidate_rows":1024,"requested_result_limit":1,"result_limit":1,"max_result_limit":200,"clauses_executed":1,"verification_dropped":0,"filter_verification_dropped":0,"candidate_budget_exhausted":false,"timed_out":false,"truncated":false},"filters":{"provider":"codex"},"freshness":{"mode":"off","status":"skipped"},"generated_at":"2026-07-01T12:00:00Z","results":[{"ctx_event_id":"11111111-1111-4111-8111-111111111111","ctx_session_id":"22222222-2222-4222-8222-222222222222","provider_session_id":"codex-fixture-session","event_seq":1,"title":"Fixture session","snippet":"local agent history search result","rank":0.98,"result_type":"event","result_scope":"event","provider":"codex","timestamp":"2026-07-01T12:00:00Z","cwd":"/workspace/ctx","source_path":"/tmp/ctx-sdk-fixture/session.jsonl","source_exists":true,"cursor":"line:2","why_matched":["text"],"citations":[{"target_type":"event","ctx_event_id":"11111111-1111-4111-8111-111111111111","ctx_session_id":"22222222-2222-4222-8222-222222222222","label":"codex event","provider":"codex","source_path":"/tmp/ctx-sdk-fixture/session.jsonl","source_exists":true,"cursor":"line:2"}],"suggested_next_commands":["ctx show event 11111111-1111-4111-8111-111111111111 --window 10","ctx locate event 11111111-1111-4111-8111-111111111111","ctx show session 22222222-2222-4222-8222-222222222222"],"visibility":"local_only"}],"pagination":{"limit":1},"truncation":{"truncated":false}}
    """
}
