...
ALTER TABLE session_active_snapshot_heads RENAME TO session_active_snapshot_heads_old;
...
INSERT INTO session_active_snapshot_heads (
  session_id,
  last_event_seq,
  turns_json,
  tool_summaries_json,
...
SELECT
  ...
  created_at,
  updated_at
FROM session_active_snapshot_heads_old;

DROP TABLE session_active_snapshot_heads_old;
